...
A tile factory has two tile printing machines ( ![  sq_mac] and ![tri_mac] ). To make a decorative tile, choose a stencil pattern and a tile and put both in one of the machines. The machine will then print the pattern on the tile. The two machines work a bit differently. 
